...
\item H. Guan, T. Arcomano, A. Chattopadhyay, \textbf{R. Maulik}: A note on the error analysis of data-driven closure models for large eddy simulations of turbulence.

\item D. Chakraborty, S. Barwey, H. Zhang, \textbf{R. Maulik}: LUCIE: A Lightweight Uncoupled ClImate Emulator with long-term stability and physical consistency for O(1000)-member ensembles, {\it arXiv:2405.16297}.
