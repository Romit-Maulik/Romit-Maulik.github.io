...
\begin{itemize}
  ...
  \item Sen Lin (University of Houston): Extreme event detection and prediction using deep learning, Givens Associateship, Summer 2022.
...
\item Non-intrusive reduced-order modeling using scientific machine learning, Guest Lecture, Summer School on Reduced Order Methods in CFD, SISSA Trieste, July 13, 2022.

\item Learning nonlinear dynamical systems from data using scientific machine learning, Brown University CRUNCH Seminar series, May 27, 2022. 
