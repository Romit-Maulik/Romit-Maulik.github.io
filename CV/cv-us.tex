...
\item D. Chakraborty, H. Guan, J. Stock, T. Arcomano, G. Cervone, \textbf{R. Maulik}: Multimodal atmospheric super-resolution with deep generative models, {\it Accepted, IOP Machine Learning: Earth}.

\item J. Botvinick-Greenhouse, M. Oprea, \textbf{R. Maulik}, Y. Yang: Measure-Theoretic Time-Delay Embedding: Analysis and Application, {\it Accepted, Journal of Statistical Physics}.
...
\item H. Guan, T. Arcomano, A. Chattopadhyay, \textbf{R. Maulik}: LUCIE: A Lightweight Uncoupled ClImate Emulator with long-term stability and physical consistency, {\it Journal of Advances in Modeling Earth Systems, Volume17, Issue 11, 2025}.
