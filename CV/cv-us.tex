...
\hypersetup{
  ...
  urlcolor = black,
  pdfauthor = {\name},
  pdfkeywords = {CFD,HPC,Numerical methods},
...
\begin{itemize}
\item Margaret Butler Postdoctoral Fellow - ALCF, Argonne National Laboratory, Jun, 2019 - Present.
\item Pre-doctoral Appointee - MCS, Argonne National Laboratory, Jan, 2019 - May, 2019
\item GRA - Computational Fluid Dynamics Laboratory, Oklahoma State University, Jan, 2016 - May, 2019.
\item GRA - Computational Biomechanics Laboratory, Oklahoma State University, Aug, 2013 - July, 2015.
\item GTA - Mechanical \& Aerospace Engineering, Oklahoma State University, Jan, 2013 - Dec, 2018.
...
\begin{itemize}
    \item Scaleable scientific machine learning for domain-specific applications.
    \item Numerical methods for turbulence closures and reduced-order modeling.
...
\begin{enumerate}
    \item \textbf{Romit Maulik} (PI), Turb-Net: Scaleable physics-informed deep learning for turbulence model development, Director's discretionary resource allocation, Argonne Leadership Computing Facility, Argonne National Laboratory.
\end{enumerate}
...
\item \textbf{R. Maulik}, A. Mohan, B. Lusch, S. Madireddy, P. Balaprakash: Time-series learning of latent-space dynamics for reduced-order model closure, {\it arXiv preprint : 1906.07815}.

\item \textbf{R. Maulik}, O. San, J. Jacob: Connecting implicit and explicit large eddy simulations of two-dimensional turbulence through machine learning, {\it arXiv preprint : 1901.09329}.

\item B. Narayanan, \textbf{R. Maulik}, M. Zhou, H. Doana, P. Balaprakash, L. A. Curtiss, R. S. Assary: Protonation of Bio-oil Components from Accurate First principles Simulations and Graph-based neural networks.

\item \textbf{R. Maulik}, V. Rao, S. Madireddy, B. Lusch, P. Balaprakash: Using recurrent neural networks for nonlinear term computation in advection-dominated dynamical systems. {\it In preparation}

\item \textbf{R. Maulik}, S. Madireddy, B. Lusch, P. Balaprakash, S. Wild: Generative reduced-order models with adaptive augmentation of training data. {\it In preparation}

\item \textbf{R. Maulik}, B. Lusch, S. Madireddy, P. Balaprakash: Precise predictions of nonlinear dynamical systems using time-delay augmented LSTMs. {\it In preparation}
...
\begin{enumerate}
    ...
    \item Invited participant, US-Japan Workshop on Data-Driven Fluid Dynamics, Kobe, Japan, 2020
...
\item \textbf{R. Maulik}, B. Lusch, O. San, P. Balaprakash: Data-driven sub-grid models for the large-eddy simulation of turbulence, Invited talk at John Zink Hamworthy Combustion Tulsa, 2019.

\item \textbf{R. Maulik}, H. Sharma, S. Patel, E. Jennings, B. Lusch, P. Balaprakash, V. Vishwanath: Novel turbulence closures using physics-informed machine learning, Argonne Physical Sciences and Engineering Division, AI Townhall 2019. 
...
\begin{itemize}
    \item Reviewer - AIAA J., Comput. Physics Commun., Int. J. Comput. Fluid D., J. Fluid Mech., Phys. Fluids.
    ...
    \item Tutorial lead - Statistical methods for machine learning, ALCF AI4Science tutorial, Argonne National Laboratory.
