...
\item \textbf{R. Maulik}, R. Egele, B. Lusch,  P. Balaprakash: Recurrent neural network architecture search for geophysical emulation, {\it arXiv:2004.10928, Under review}.
...
\item \textbf{R. Maulik}, K. Fukami, N. Ramachandra, K. Fukagata, K. Taira : Probabilistic neural networks for fluid flow model-order reduction and data recovery, {\it arXiv preprint : 2005.04271, Under review}.
...
\item \textbf{R. Maulik}, H. Sharma, S. Patel, B. Lusch, E. Jennings: Deploying deep learning in OpenFOAM with TensorFlow: a tutorial, {\it In preparation}
...
\item S. Renganathan, \textbf{R. Maulik}, V. Rao: Nonintrusive Reduced Order Modeling for Systems with Parameter-Dependent Discontinuities, {\it In preparation}, 2020.

\item \textbf{R. Maulik}, S. Renganathan, V. Rao: Airfoil shape optimization using differentiable surrogate models, {\it In preparation}, 2020.
