...
\begin{minipage}{0.45\linewidth}
  \href{http://www.mcs.anl.gov/}{Mathematics and Computer Science Division,} \\
...
\begin{itemize}
\item Assistant Computational Scientist, Maths and Computer Science Division, Jun, 2021 - Present.
...
\item Member of program committee - International Conference on Parallel Processing, Chicago, 2021 (Reviewed 6 articles).
\end{itemize}
...
% \item R. Egele, \textbf{R. Maulik}, K. Raghavan, B. Lusch, P. Balaprakash: Neural architecture search ensembles for uncertainty quantification in deep learning.
...
\item \textbf{R. Maulik}: Parallelized emulator discovery and uncertainty quantification using DeepHyper, Invited talk, Mechanistic Machine Learning and Digital Twins for Computational Science, Engineering \& Technology, September 26-29, 2021.

\item \textbf{R. Maulik}: Scalable scientific machine learning for computational fluid dynamics, Plenary talk, Computational Sciences and AI in Industry, June 7-9, 2021.

\item \textbf{R. Maulik}: Neural architecture search for surrogate modeling, Invited talk, DDPS Seminar Series, Lawrence Livermore National Laboratory, May 27, 2021.
