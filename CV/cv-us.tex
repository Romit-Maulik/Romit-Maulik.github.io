...
\item C. Moss, R. Maulik, G. V. Iungo: Modeling Wind Turbine Performance and Wake Interactions with Machine Learning.
...
\item V. Shankar, V. Puri, R. Balakrishnan, \textbf{R. Maulik}, V. Vishwanathan: Differentiable physics-enabled closure modeling for Burgers' turbulence.
