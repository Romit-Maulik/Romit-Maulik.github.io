...
\item  \textbf{Starting July 2023} \\ Assistant Professor, Information Sciences and Technology, Institute of Computational and Data Sciences, Pennsylvania State University \\ \& \\ Joint Appointment, Mathematics and Computer Science Division, Argonne National Laboratory.
...
\item Invited participant, SIAM Convening on Climate Science, Sustainability, and Clean Energy (DMS 2227218), Tysons Corner, Virginia, October 10-12, 2022. White paper available here: \\ \texttt{https://sinews.siam.org/Details-Page/change-the-conversation-at-the-local-level}.

\item Best paper award with Sudeepta Mondal, Gina M. Magnotti, Bethany Lusch, and Roberto Torelli. ASME Internal Combustion Engine Fall Conference, 2021.
...
\begin{itemize}
  ...
  % \item (Active) Community Research on Climate and Urban Science, U.S. Department of Energy (Biological and Environmental Research), Role: Co-PI (PI-Cristina Negri); Year 2022-2027. 

  \item (Active) Inertial neural surrogates for stable dynamical prediction, U.S. Department of Energy (Advanced Scientific Computing Research), Role: Institutional PI; Year 2021-2024.

  \item (Active) AI emulator assisted data assimilation, Future computing, LDRD-Prime, Argonne National Laboratory, U.S. Department of Energy. Role: Co-PI (PI-Rao Kotamarthi); Year: 2021--2023.

  \item (Active) RAPIDS2: A SciDAC Institute for Computer Science, Data, and Artificial Intelligence, U.S. Department of Energy. Role: Senior Personnel (PI-Rob Ross); Year: 2020--2025.

  \item (Active) Prediction-to-Mitigation with Digital Twins of the Earth's Weather, MOE Tier-2 Grant, Singapore. Role: External Collaborator (PI-Gianmarco Mengaldo).

  \item (Finished) A Scalable, Energy Efficient HPC Environment for AI-Enabled Science, National Science Foundation Collaborative PPoSS funding. Role: Co-PI (PI-Zhiling Lan); Year 2021-2022.

  \item (Finished) SambaWF: Highly resolved surrogate models for weather forecasting, LDRD-Expedition, Argonne National Laboratory, U.S. Department of Energy. Role: PI; Year: 2021-2021. 

  \item (Finished) Scalable machine learning for turbulence closure and reduced-order modeling, Margaret Butler Fellowship, Role: PI, Year: 2019-2021. 
...
\begin{itemize}
  ...
  \item Shivam Barwey, PhD, Postdoctoral Fellow, Argonne Leadership Computing Facility, Argonne National Laboratory (2022-Present).
...
\item C. Moss, \textbf{R. Maulik}, G. V. Iungo: Modeling Wind Turbine Performance and Wake Interactions with Machine Learning.

\item C. Moss, M. Puccioni, \textbf{R. Maulik}, C. Jacquet, D. Apgar, G. V. Iungo : Predicting Wind Farm Operations with Machine Learning and the P2D-RANS model: A Case Study for an AWAKEN Site, 
...
\item A. Aygun, \textbf{R. Maulik}, A. Karakus: Physics-Informed Neural Networks for Mesh Deformation with Exact Boundary Enforcement, {\it arXiv:2301.05926}.
...
\item \textbf{R. Maulik}, R. Egele, K. Raghavan, P. Balaprakash: Quantifying uncertainty for deep learning based forecasting and flow-reconstruction using neural architecture search ensembles.
...
\item S. Bhola, S. Pawar, P. Balaprakash, \textbf{R. Maulik}: Multi-fidelity reinforcement learning framework for shape optimization, {\it Journal of Computational Physics, Accepted}, 2023.
...
\item PythonFOAM: In-situ data-analyses and scientific machine learning with Python and OpenFOAM, \textbf{Invited talk}, USACM Workshop on Establishing Benchmarks for Data-Driven Modeling of Physical Systems, University of Southern California, April, 2023.
