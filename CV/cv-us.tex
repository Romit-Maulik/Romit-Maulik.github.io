...
\item \textbf{R. Maulik}, S. Renganathan, V. Rao: Airfoil shape optimization using differentiable surrogate models.

\item \textbf{R. Maulik}, T. Botsas, N. Ramachandra, I. Pan, M. Lachlan: Latent-space time evolution of non-intrusive reduced-order models using Gaussian process regression.
...
\item \textbf{R. Maulik}, N. Garland, X. Tang, P. Balaprakash: Neural network representability of fully ionized plasma fluid model closures, {\it Accepted - Physics of Plasmas, 2020}.
