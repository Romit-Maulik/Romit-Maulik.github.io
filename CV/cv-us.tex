...
\item \textbf{R. Maulik}, S. Renganathan, V. Rao: Machine Learning enablers for aerospace design optimization.

\item S. Pawar, \textbf{R. Maulik}: Run-time optimization of steady-state solvers using scalable deep reinforcement learning.

\item K. Fukami, \textbf{R. Maulik}, N. Ramachandra, K. Taira, K. Fukagata: Voronoi CNNs: Interfacing unstructured data with predesigned convolutional architectures for fluid flow super resolution.
...
\item \textbf{R. Maulik}, R. Egele, B. Lusch,  P. Balaprakash: Recurrent neural network architecture search for geophysical emulation, {\it arXiv:2004.10928}.
...
\item \textbf{R. Maulik} : Surrogate-based machine-learning for system optimization, \textbf{Invited talk} at Los Alamos National Laboratory for Tokamak Disruption Simulation (TDS) working group.
