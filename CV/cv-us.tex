...
\item \textbf{R. Maulik}, S. Puligilla, B. Lusch, P. Balaprakash: Lessons learned from neural machine translation: Using attention to stabilize LSTM-based non-intrusive reduced-order models, {\it In preparation}.
...
\item S. Renganathan \textbf{R. Maulik}, V. Rao : Machine-Learning for Nonintrusive Model Order Reduction of the Parametric Inviscid Transonic Flow past an airfoil, {\it Accepted, Physics of Fluids}.

\item \textbf{R. Maulik}, O. San: Numerical assessments of a parametric implicit large eddy simulation model, {\it Accepted, Journal of Computational and Applied Mathematics}.

\item S. Renganathan, \textbf{R. Maulik}, V. Rao: Nonintrusive Reduced Order Modeling for Systems with Parameter-Dependent Discontinuities, {\it Accepted, 2020 AIAA AVIATION Forum and Exposition}.
