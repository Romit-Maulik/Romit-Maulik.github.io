...
\item S. Pawar, \textbf{R. Maulik}: Run-time optimization of steady-state solvers using scalable deep reinforcement learning, {\it arxiv:2009.10306}.
...
\item \textbf{R. Maulik}, K. Fukami, N. Ramachandra, K. Fukagata, K. Taira : Probabilistic neural networks for fluid flow model-order reduction and data recovery, {\it Accepted in Physical Review Fluids, arXiv preprint : 2005.04271}.
