...
\item Seed for Success Acorn Award for Purdue faculty and staff who have received a sponsored grant equal to or greater than \$950k in FY26, Purdue University, 2026. 

\item The John Argyris Award for Young Scientists, International Association for Computational Mechanics, 2026.

\item Distinguished Young Alumni Award for Excellence in Teaching and Research in Engineering \& Technology, Birla Institute of Technology, Mesra, 2026.

\item ASME Rising Star of Mechanical Engineering, 2026.
...
%   \item (Active, 2026-2027) Agentic Construction and Manipulation of Diffusion Generative Models for Scientific Machine Learning, Eli Lilly Company and Purdue University Research Alliance Center, Role: PI.

%   \item (Active, 2026-2029) Multifidelity data assimilation for improved subgrid and wall-modeling in large eddy simulations of hypersonic flows, ONR, Role: PI.

%   \item (Active, 2026-2029) Integrating Graph Neural Operator with MOOSE Framework for Enhanced Transient Modeling and Real-Time Data Assimilation, DOE NEUP, Role: Institutional PI.

%   \item (Active, 2026) Diffusion posterior sampling with multimodal language models for adaptive sensor and model fusion, DARPA, Role: PI.
...
\begin{itemize}
  ...
  \item Dr. Sen Wang$^\ast$, Postdoctoral Scholar, Purdue University, 2026-Present.

  \item Dr. Abdullah Al-Mamun$^\ast$, Postdoctoral Scholar, Purdue University, 2026-Present.

  \item Hojin Kim$^\ast$, PhD Student, Purdue University, 2024-Present.

  \item Ashwin Suriyanarayan$^\ast$, PhD Student, Purdue University, 2025-Present.

  \item Kanad Sen$^\ast$, PhD Student, Purdue University, 2026-Present.

  \item Keon Wong Hur$^\ast$, PhD Student, Purdue University, 2026-Present.

  \item Euiyoung Kim$^\ast$, PhD Student, Purdue University, 2026-Present.

  \item Yelim Kim$^\ast$, PhD Student, Purdue University, 2026-Present.

  \item Advait Menon$^\ast$, PhD Student, Purdue University, 2026-Present.

  \item Sebastian Mares$^\ast$, MS Student, Purdue University, 2026-Present.

  \item Shabarish Balaji$^\ast$, MS Student, Purdue University, 2026-Present.

  \item Dibyajyoti Chakraborty, PhD Student, Pennsylvania State University, 2023-2026, (Next position - Research Engineer - Nvidia).

  \item Haiwen Guan, PhD Student, Pennsylvania State University, 2024-2026, (Next position - Postdoc at Argonne National Laboratory.)
...
\item A. Suriyanarayanan, \textbf{R. Maulik}, Improving Reduced-Order Rotating Detonation Engine Models with Data Assimilation and Machine Learning, {\it arXiv:2609.16237}.

\item D. Chakraborty, \textbf{R. Maulik}, Multimodal spatiotemporal atmospheric data assimilation with latent video flow matching, {\it arXiv:2608.05103}.

\item K. Sen, \textbf{R. Maulik}, Scale-Aware Learning of Chaotic Dynamics on Unstructured Meshes via Binned Spectral Losses, {\it arXiv:2607.19387}.

\item H. Kim, D. Chakraborty, T. Toki, C. Scalo, \textbf{R. Maulik}, Multiscale Hypersonic Boundary Layer Reconstruction via Spectral Binning and Subdomain-wise Conditional Diffusion, {\it arXiv:2606.15023}.

\item A. Suriyanarayanan, D. Chakraborty, \textbf{R. Maulik}, Deep Learning of Solver-Aware Turbulence Closures from Nudged LES Dynamics, {\it arXiv:2604.23874}.

\item D. Chakraborty, H. Kim, \textbf{R. Maulik}, Adaptive Diffusion Posterior Sampling for Data and Model Fusion of Complex Nonlinear Dynamical Systems, {\it arXiv:2603.12635}.

\item S. Das, D. Chakraborty, \textbf{R. Maulik}, SC3D: Dynamic and Differentiable Causal Discovery for Temporal and Instantaneous Graphs, {\it Arxiv:2602.02830}.
...
You can find virtually every paper below on the Arxiv. If you cannot, please email me for a copy.

\begin{enumerate}

\item H. Guan, M. Darmian, D. Chakraborty, T. Arcomano, A. Chattopadhyay, \textbf{R. Maulik}, High-Resolution Climate Projections Using Diffusion-Based Downscaling of a Lightweight Climate Emulator, {\it Accepted, Journal of Geophysical Research: Machine Learning and Computation, arXiv:2602.13416}.

\item H. Guan, T. Arcomano, A. Chattopadhyay, \textbf{R. Maulik}, LUCIE-3D: A three-dimensional climate emulator for forced responses, {\it Accepted, Geoscientific Model Development, Arxiv: 2509.02061}.

\item H. Kim, V. Shankar, V. Vishwanathan, \textbf{R. Maulik}: Generalizable data-driven turbulence closure modeling on unstructured grids with differentiable physics, {\it Accepted, Computers and Fluids, 2026}.

\item M. Dhingra, \textbf{R. Maulik}, A. Rasheed, O. San: Localized PCA-Net neural operators for scalable solution reconstruction of elliptic PDEs, Machine Learning for Computational Science and Engineering, 2:22, 2026.

\item X. Li, \textbf{R. Maulik}: SALSA-RL: Stability Analysis in the Latent Space of Actions for Reinforcement Learning, {\it Neural Networks}, Volume 201, 108957, 2026.

\item D. Chakraborty, A. Mohan, \textbf{R. Maulik}: Binned Spectral Power Loss for Improved Prediction of Chaotic Systems,  {\it Journal of Computational Physics}, Volume 558, 114866, 2026.

\item X. Wang, J. Yang, J. Adie, K. Furtado, C. Chen, T. Arcomano, \textbf{R. Maulik}, G. Mengaldo: CondensNet: Enabling stable long-term climate simulations via hybrid deep learning models with adaptive physical constraints, {\it npj Climate and Atmospheric Science}, 9 (1), 7, 2026.
...
\item X. Li, M. Masmoudi, R. Gharbi, N. Lajnef, V. Boddeti, J. Harlim, \textbf{R. Maulik}: Neural-VSI: Variational System Identification of Structural Parameter Fields in High-Order PDEs, ICLR Workshop on Artificial Intelligence and Partial Differential Equations, 2026, Rio De Janeiro, Brazil.
...
\item How can the differentiable physics paradigm be used without adjoints?, \textbf{Invited Talk}, Data-driven Modelling for Mechanical Systems Summer School 2026, IIT (ISM) Dhanbad, July 1, 2026.

\item Bypassing backpropagation through time for the learning of chaotic dynamical systems, \textbf{Invited Keynote}, US National Congress on Theoretical and Applied Mechanics, Pasadena, CA, June 2026.

\item Nudging-based data assimilation for interpretable scientific machine learning, \textbf{Invited Talk}, EuroMech Colloquium on Physics-enhanced machine learning and data-driven nonlinear dynamics, Lake Como, Italy, April 28, 2026.

\item No more adjoints: Calibrating chaotic dynamical systems with weak-form learning, \textbf{Invited Talk}, Workshop on Scientific Machine Learning, Korea Institute for Advanced Study, March 26, 2026.
...
\item Multimodal data and model fusion for high-dimensional dynamical systems, \textbf{Invited Talk}, PC-13: Data-Driven Modeling of Combustion Dynamics AIAA 2026 Panel Session, January 2026.
...
\item Scientific machine learning for forecasting dynamical systems exhibiting deterministic chaos, \textbf{Invited talk}, Summer School: Scientific Machine Learning, Brin Mathematics Research Center, University of Maryland, August 2025.
...
\item Predicting the long-term behavior of chaotic dynamical systems with scientific machine learning, \textbf{Invited talk}, CRM-IVADO Workshop on Accuracy and Efficiency in Scientific Machine Learning, Universit\'{e} de Montr\'{e}al, June 2025. 
...
\item Non-intrusive reduced-order modeling with quantum reservoir computing, \textbf{Keynote talk}, IACM Digital Twins in Engineering and ECCOMAS Artificial Intelligence and Computational Methods in Applied Science, February 2025, Paris, France.
...
\item Differentiable physics for closure modeling from data, \textbf{Invited talk}, Office of Naval Research Erosion Workshop, Johns Hopkins University, August 14, 2024.
...
\item Multiscale Graph Neural Network Architectures for Interpretable Scientific Machine Learning, \textbf{Invited talk}, Center for Mathematics and AI Seminar Series, George Mason University, October, 2023.
...
\item Quantifying Uncertainty in Deep Learning for Fluid Flow Reconstruction, USACM Thematic Conference on Uncertainty Quantification for Machine Learning Integrated Physics Modeling (MLIP), Crystal City, Virginia, August 18-19, 2022.
...
\item Scalable scientific machine learning for computational fluid dynamics, \textbf{Plenary talk}, ECCOMAS Thematic Conference on Computational Sciences and AI in Industry, June 7-9, 2021.

\item Neural architecture search for surrogate modeling, \textbf{Invited talk}, Data-driven Physical Sciences Seminar Series, Lawrence Livermore National Laboratory, May 27, 2021.
...
\item Incorporating Inductive Biases as Hard Constraints for Scientific Machine Learning, \textbf{Invited talk}, MCS-LANS seminar, Argonne National Laboratory, February 2021.
...
\item Machine Learning Enablers for System Optimization and Design, \textbf{Invited talk}, MCS-LANS seminar, Argonne National Laboratory, August 2020.
...
\item Machine Learned Reduced-Order Models for Advective Partial Differential Equations, \textbf{Invited talk}, MCS-LANS seminar, Argonne National Laboratory, February, 2020.
...
\item Data-driven deconvolution for the sub-grid modeling of large eddy simulations of two-dimensional turbulence, \textbf{Invited talk}, SIAM-CSE, March, 2019.
...
\begin{itemize}
  \item Associate Editor - Results in Engineering, AI Thermal Fluids, International Journal for Multiscale Computational Engineering.
