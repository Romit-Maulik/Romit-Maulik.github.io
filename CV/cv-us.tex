...
\item A. Nair, S. Barwey, P. Pal, J. MacArt, \textbf{R. Maulik}: Understanding Latent Timescales in Neural Ordinary Differential Equation Models for Advection-Dominated Dynamical Systems, {\it Physica D, Accepted}.

\item Z. Malik, \textbf{R. Maulik}: A competitive baseline for deep learning enhanced data assimilation using conditional Gaussian ensemble Kalman filtering, {\it Computer Methods in Applied Mechanics and Engineering, Accepted}.
