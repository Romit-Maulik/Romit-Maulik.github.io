...
\begin{itemize}
  ...
  \item Pranav Bahl$^\ast$, Graduate Student, Pennsylvania State Univeristy, 2024-Present.
...
\item S. Yang, H. Kim, Y. Hong, K. Yee, \textbf{R. Maulik}, N. Kang:  Data-driven Physics-Informed Neural Networks: A Digital Twin Perspective.

\item T. Nguyen, R. Shah, H. Bansal, T. Arcomano, S. Madireddy, \textbf{R. Maulik}, V. Kotamarthi, I. Foster, A. Grover: Scaling transformer neural networks for skillful and reliable medium-range weather forecasting, {\it arXiv:2312.03876}.

\item S. Barwey, \textbf{R. Maulik}: Interpretable Fine-Tuning for Graph Neural Network Surrogate Models, {\it arXiv:2311.07548}.

\item D. Aulakh, \textbf{R. Maulik}: Generalizable improvement of the Spalart-Allmaras model through assimilation of experimental data, {\it arXiv:2309.06679}.
