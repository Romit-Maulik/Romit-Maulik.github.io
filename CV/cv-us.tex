...
\item \textbf{R. Maulik}, N. Ramachandra : Probabilistic model-order reduction for imperfect data, {\it In preparation}.

\item \textbf{R. Maulik}, R. Egele, P. Balaprakash, B. Lusch: Scalable searches of recurrent neural architectures for geophysical emulation, {\it In preparation}.
