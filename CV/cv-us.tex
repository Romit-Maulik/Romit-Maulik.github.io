...
\item H. Guan, T. Arcomano, A. Chattopadhyay, \textbf{R. Maulik}: A note on the error analysis of data-driven closure models for large eddy simulations of turbulence, {\it arXiv:2405.17612}.
...
\item S. Yang, H. Kim, Y. Hong, K. Yee, \textbf{R. Maulik}, N. Kang:  Data-driven Physics-Informed Neural Networks: A Digital Twin Perspective, {\it Accepted, Computer Methods in Applied Mechanics and Engineering, arXiv:2401.08667}.

\item M. Rogowski, B. Yeung, O. Schmidt, \textbf{R. Maulik}, M. Parsani, L. Dalcin, G. Mengaldo: Unlocking massively parallel spectral proper orthogonal decompositions in the PySPOD package, {\it Accepted, Computer Physics Communications, arXiv:2309.11808}.

\item K. Asztalos, R. Steijl, \textbf{R. Maulik}: Reduced-order modeling on a near-term quantum computer, {\it Accepted, Journal of Computational Physics}.
...
\item D. Chakraborty, S. Barwey, H. Zhang, \textbf{R. Maulik}: LUCIE: A Lightweight Uncoupled ClImate Emulator with long-term stability and physical consistency for O(1000)-member ensembles, (Machine Learning for Earth System Modeling Workshop, ICML 2024), {\it arXiv:2405.16297}
...
\item Differentiable physics for turbulence closure modeling from data, \textbf{Invited talk}, University of Marlyand Numerical Analysis Seminar Series, April 2, 2024.
