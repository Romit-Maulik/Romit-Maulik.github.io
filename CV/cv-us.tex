...
\item S. Renganathan \textbf{R. Maulik}, V. Rao : Machine learning based model order reduction of inviscid transonic flow past an airfoil, {\it arXiv preprint : 1911.07943, Under review}.
...
\item \textbf{R. Maulik}, A. Rappaport, B. Lusch, P. Balaprakash, J. Shadid: Stable non-intrusive ROMS using non-autoregressive time series methods, {\it In preparation}.
