...
\begin{itemize}
  ...
  \item Sen Lin (University of Houston): Probabilistic machine learning for high-dimensional dynamical systems, Givens Associateship, Summer 2022.
...
\item \textbf{R. Maulik}, V. Rao, J. Wang, G. Mengaldo, E. Constantinescu, B. Lusch, P. Balaprakash, I. Foster, R. Kotamarthi, AIEADA 1.0: Efficient high-dimensional variational data assimilation with machine-learned reduced-order models, {\it Accepted, Geoscientific Model Development, arXiv:2112.07856}.
...
\item S. Renganathan, \textbf{R. Maulik}, G. Iungo, S. Letizia: Data-driven wind turbine wake modeling using probabilistic machine learning, {\it Neural Computing and Applications}, 1-16, 2022.
...
\item Reduced-order modeling of high-dimensional systems using scientific machine learning, \textbf{Invited talk}, APS March Meetings, March 14, 2022.

\item ", \textbf{Invited talk}, National University of Singapore, Department of Mechanical Engineering, Distinguished Seminar Series, February 10, 2022.
...
\begin{itemize}
  \item Organizer - Non-intrusive reduced-order modeling via deep learning strategies, ECCOMAS Congress, 2022, Oslo Norway.
  \item Organizer - Data-driven methods for reduced-order modeling session, Copper Mountain Conference on Iterative and Multigrid Methods, 2022.
